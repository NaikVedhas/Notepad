...
//import './notepad.css'
import contract_abi from "./contractmeta/abi.json";
import contract_address from "./contractmeta/address";
...
const NotesTextArea = () => {
    ...
    const addd = async() => {
        ...
        const tx  =await contracts.add(notes);
        await tx.wait();
...
<form className="mx-20 my-20">
  ...
  {/* <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800" onClick={ () => { }}>
    Add
  </button> */}

  <button type="submit" className="inline-flex items-center px-5 py-2.5 text-sm font-medium text-center text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800"  onClick={()=> addd() } >
    Submit
  </button>
</div>
